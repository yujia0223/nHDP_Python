...
def calculate_relatedness(parent_topic, child_topics, texts, level):
    ...
    if relatedness_scores:
        min_coverage = min(relatedness_scores)
        max_coverage = max(relatedness_scores)
        avg_coverage = sum(relatedness_scores) / len(relatedness_scores)
    else:
