...
def calculate_coverage_vocab(topics, texts): # word level same as calculate coverage
    # Flatten the list of documents into a single list of words
    all_words = [word for doc in texts for word in doc]
    # print('all words in original texts',all_words)
    word_counts = Counter(all_words)
...
def calculate_coverage_doc(topics, texts): # doc level
    # Flatten the list of documents into a single list of words
    all_words = [word for doc in texts for word in doc]
    # print('all words in original texts',all_words)
    word_counts = Counter(all_words)
...
def calculate_coverage_3(topics, texts, normalize=False):
    topic_coherences = []
    num_docs = len(texts)
...
def calculate_coverage_simple(topics, texts):
    topics_coverage = {}
    for topic in topics:
        count = 0
        # print(topic)
        if topic:
            ...
            topics_coverage[tuple(topic)] = count/len(replaced_docs)
    return topics_coverage
...
#     coverage_score_1 = calculate_coverage_1(unique_topics, texts)
#     coverage_score_2 = calculate_coverage_2(unique_topics, texts)

#     coverage_level.append(coverage_score)
#     coverage_level_simple.append(coverage_score_simple)
#     coverage_level_1.append(coverage_score_1)
#     coverage_level_2.append(coverage_score_2)
...
# print('coverage for the hierarchical levels vocab count 2',coverage_level_1)
# print('coverage for the hierarchical levels docs count',coverage_level_2)