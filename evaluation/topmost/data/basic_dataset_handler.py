...
class RawDatasetHandler:
    def __init__(self, docs, preprocessing, predicates, objects, embedding_model,batch_size=200, device='cpu', as_tensor=False, contextual_embed=False):

        rst = preprocessing.preprocess(docs, predicates, objects, embedding_model)
